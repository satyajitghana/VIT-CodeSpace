...
## Development environment and release process
 ...
 - create virtualenv with Flask and student_performance installed into it (latter is installed in
...
install it (`pip install student_performance.tar.gz`), ensure that configuration file exists and
`STUDENT_PERFORMANCE_SETTINGS` environment variable points to it, ensure that user has access to the
